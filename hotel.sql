...
INSERT INTO `employee` (`EMPLOYEE_NUMBER`, `IS_MANAGER`, `POSITION`, `EMPLOYEE_PAY`, `EMPLOYEE_HIRE_DATE`, `EMPLOYEE_NOTES`, `EMPLOYEE_ADRESS`, `EMPLOYEE_STANDARD_HOURS`, `LOCATION_NUM`, `EMPLOYEE_EMAIL`) VALUES
(0, 1, 'Hotel Owner', 150000, '2023-03-01', 'Is the big boss man', 'At the hotel', '24/7 365', 1, 'hotel@hotel.com'),
(1, NULL, 'Concierge Manager', 60000, '2023-05-04', 'First Employee', '113 Parkway', 'M-F 8am : 5pm', 1, 'frontDesk@hotel.com');
